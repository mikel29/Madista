<?php
	...
	$campos="producto.producto_id,producto.producto_nombre,producto.categoria_id,producto.producto_detalles,producto.producto_color,producto.producto_tamaño,producto.producto_material,producto.producto_cantidad,producto.fecha_de_ingreso,producto.precio_compra_unidad,producto.producto_proveedor,producto.producto_precio,producto.producto_foto";
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id INNER JOIN usuario ON producto.usuario_id=usuario.usuario_id WHERE producto.categoria_id='$categoria' ORDER BY producto.producto_nombre ASC LIMIT $inicio,$registros";
